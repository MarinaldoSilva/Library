...
from .views import BorrowingCreateAPIView, BorrowingDeleteAPIView, BorrowingDetailAPIView, BorrowingListAPIView, BorrowingRenewalAPIView, BorrowingUpdateAPIView
